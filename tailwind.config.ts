  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "mobile-wave-1": "mobile-wave-1 6s ease-in-out infinite",
        "mobile-wave-2": "mobile-wave-2 7s ease-in-out infinite",
        "mobile-wave-3": "mobile-wave-3 8s ease-in-out infinite",
        "mobile-float-1": "mobile-float-1 4s ease-in-out infinite",
        "mobile-float-2": "mobile-float-2 5s ease-in-out infinite",
        "mobile-float-3": "mobile-float-3 6s ease-in-out infinite",
        "mobile-pulse-corner": "mobile-pulse-corner 3s ease-in-out infinite",
        "mobile-scan-line": "mobile-scan-line 4s ease-in-out infinite",
        "mobile-aurora-1": "mobile-aurora-1 5s ease-in-out infinite",
        "mobile-aurora-2": "mobile-aurora-2 6s ease-in-out infinite",
        "enhanced-mobile-float-1": "enhanced-mobile-float-1 4s ease-in-out infinite",
        "enhanced-mobile-float-2": "enhanced-mobile-float-2 5s ease-in-out infinite",
        "enhanced-mobile-float-3": "enhanced-mobile-float-3 6s ease-in-out infinite",
        "enhanced-mobile-pulse": "enhanced-mobile-pulse 3s ease-in-out infinite",
        "enhanced-mobile-wave-1": "enhanced-mobile-wave-1 7s ease-in-out infinite",
        "enhanced-mobile-wave-2": "enhanced-mobile-wave-2 8s ease-in-out infinite",
        "enhanced-mobile-wave-3": "enhanced-mobile-wave-3 9s ease-in-out infinite",
      },
      boxShadow: {
