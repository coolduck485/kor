...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <TooltipPrimitive.Content
    ...
    className={cn(
      "z-50 overflow-hidden rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 px-4 py-2.5 text-sm font-medium text-white shadow-xl border border-blue-500/20 backdrop-blur-sm",
      "animate-in fade-in-0 zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95",
      "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
      "relative",
      // Speech bubble tail styles
      "after:absolute after:content-[''] after:w-3 after:h-3 after:bg-gradient-to-r after:from-blue-600 after:to-blue-700 after:border-blue-500/20",
      ...
      "before:absolute before:content-['›'] before:text-white/80 before:font-bold before:text-lg",
