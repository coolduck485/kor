      ...
      >
        ...
        <div className="relative min-h-screen py-16 sm:py-20 lg:py-24 section-container">
          ...
          >
            ...
            {/* Services Grid */}
            <div className="flex flex-row sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-1 sm:gap-6 lg:gap-8 xl:gap-10 mt-16 responsive-grid overflow-x-auto sm:overflow-x-visible">
